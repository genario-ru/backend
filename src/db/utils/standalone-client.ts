...
/**
 * Создаёт автономный (standalone) клиент базы данных для CLI-инструментов:
 * миграций и сида.
 *../schema
 ...
 * весь набор env, требуемый приложением. Это позволяет запускать инструменты в
 * урезанном one-shot контейнере (см. сервис `migrate` в docker-compose.yml).
 */
