CREATE TYPE "public"."status" AS ENUM('active', 'overdue', 'cancelled');--> statement-breakpoint
...
CREATE TYPE "public"."type" AS ENUM('info', 'warning', 'negative', 'positive');--> statement-breakpoint
...
ALTER TABLE "idea_variant" ADD CONSTRAINT "idea_variant_ideas_list_id_ideas_list_id_fk" FOREIGN KEY ("ideas_list_id") REFERENCES "public"."ideas_list"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "idea_variant" ADD CONSTRAINT "idea_variant_video_type_id_video_type_id_fk" FOREIGN KEY ("video_type_id") REFERENCES "public"."video_type"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
