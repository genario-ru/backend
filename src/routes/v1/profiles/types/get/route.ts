...
import { getProfileTypesResponseSchema, type GetProfileTypesResponse } from "@/schemas/entities/profiles/handlers/get-profile-types/response";
...
getProfileTypesRoute.get("/", sessionMiddleware, async (c) => {
  ...
  return c.json<GetProfileTypesResponse>(getProfileTypesResponseSchema.parse({
